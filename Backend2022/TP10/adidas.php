...
<body>
  ...
  <button type="submit"><a href="listartp10.php">Inicio</a></button>
  ...
  <h2>Lista de ropa</h2>
  <p>La siguiente lista muestra los prodcutos Adidas en stock.</p>
  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        $consulta="SELECT * FROM `ropa` WHERE `marca` LIKE 'adidas'";
